...
<button type="submit" name="nav-modificar" value="Anterior" <?= isset($btn)?$btn:'' ?>> Anterior << </button>
<button type="submit" name="nav-modificar" value="Siguiente" <?= isset($btn)?$btn:'' ?>> Siguiente >> </button>
